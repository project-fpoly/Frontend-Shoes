  ...
  return (
    <Space direction="vertical" style={{ width: "100%" }}>
      ...
      <Space direction="vertical" style={{width: '100%', textAlign: 'center'}}>
        ...
        <Typography className="mb-5 text-lg">Show 'em how you ball with the newest Air Jordan XXXVIII Low. Alumni Blue' nods to the icons of collegiate  <br /> hoops history, with pops of blue across its all-black silhouette.</Typography>

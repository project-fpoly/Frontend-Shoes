      ...
      <form onSubmit={handleSubmit(onSubmit)} action="">
            ...
            {openUserName ? (
              <>
                <div className="flex flex-col gap-3 relative w-[250px]">
                  ...
                  <span
                    ...
                    className="absolute right-[5%] cursor-pointer top-[51%] "
                  >
                    <MdOutlineCancel />
                  </span>
                </div>
              ...
              <>
                <div className="flex flex-col gap-3 relative w-[250px]">
                  ...
                  />
                  <span
                    onClick={() => setOpenUseName(!openUserName)}
                    className="absolute cursor-pointer right-[5%] top-[51%] "
                  >
                    <FaEdit />
                  </span>
                </div>
            ...
            {OpenPhoneNumber ? (
              ...
              <>
                <div className="flex flex-col gap-3 relative w-[250px]">
                  ...
                  />
                  <span
                    onClick={() => setOpenPhoneNumber(!OpenPhoneNumber)}
                    className="absolute cursor-pointer right-[5%] top-[51%] "
                  >
                    <FaEdit />
                  </span>
        ...
        {preUserName === user.userName &&
          ...
          <>
            <p
              onClick={() => setOpenGender(!openGender)}
              className=" w-[65px] cursor-pointer opacity-35 rounded-lg bg-black  px-3 py-1 text-white right-[5%] top-[51%] mt-10 "
            >
              SAVE{' '}
            </p>
          </>
          ...
          <>
            <button
              onClick={() => setOpenGender(!openGender)}
              className="cursor-pointer rounded-lg bg-black  px-3 py-1 text-white right-[5%] top-[51%] mt-10 "
            >
              {loading === 'pending' ? (
                <>
                  <Spin

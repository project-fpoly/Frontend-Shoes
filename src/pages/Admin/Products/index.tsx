...
const ProductsManager: React.FC = () => {
    ...
    },
    {
      ...
      render: (images, record) => (
        <Image
          ...
          width={50}
          className="action-cell"
          style={{ opacity: record.isDeleted ? 0.2 : 1 }}
        />
      ),
    },
    {
      ...
      render: (quantity, record) => {
        ...
        return <span style={textStyle}>{quantity}</span>
      },
    },
  ...
  const defaultValue: IProduct = {
    ...
    images: [],
    video:
      'https://res.cloudinary.com/dxspp5ba5/video/upload/v1708955796/dior-air-jordan-1-cinematic-sneaker-video_z63c37.mp4',
  ...
  const Value = {
    ...
    categoryId:
      typeof productsState?.categoryId === 'object' &&
      productsState?.categoryId?.name
        ? productsState?.categoryId._id
        : '',
    price: productsState?.price ? productsState?.price : 0,
    sale:
      typeof productsState?.sale === 'object' && productsState?.sale?._id
        ? productsState?.sale._id
        : '',
    ...
    release_date: productsState?.release_date
      ? productsState?.release_date
      : '',
    images: productsState?.images
      ? productsState?.images
      : [
          'https://res.cloudinary.com/dxspp5ba5/image/upload/v1708917683/cld-sample-5.jpg',
          'https://res.cloudinary.com/dxspp5ba5/image/upload/v1708917683/cld-sample-5.jpg',
        ],
    video: productsState?.video
      ? productsState?.video
      : 'https://res.cloudinary.com/dxspp5ba5/video/upload/v1708955796/dior-air-jordan-1-cinematic-sneaker-video_z63c37.mp4',
    blog: productsState?.blog
      ? productsState?.blog
      : '61f2a4c8e9a82f001f9e4a1c',

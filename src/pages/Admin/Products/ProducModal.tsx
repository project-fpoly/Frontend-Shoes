    ...
    <Descriptions title="Product Details" bordered column={1}>
      <Descriptions.Item>
        <Row gutter={16}>
          ...
          <Col span={16}>{selectedProduct.product_id}</Col>
        </Row>
      </Descriptions.Item>
      ...
      <Descriptions.Item>
        <Row gutter={16}>
          ...
          <Col span={16}>{selectedProduct.description}</Col>
        </Row>
      </Descriptions.Item>
      ...
      <Descriptions.Item>
        <Row gutter={16}>
          ...
          <Col span={16}>{selectedProduct.quantity}</Col>
        </Row>
      </Descriptions.Item>
      ...
      <Descriptions.Item>
        <Row gutter={16}>
          ...
          <Col span={16}>{selectedProduct.sold_count}</Col>
        </Row>
      </Descriptions.Item>
      ...
      <Descriptions.Item>
        <Row gutter={16}>
          ...
          <Col span={16}>{selectedProduct.color}</Col>
        </Row>
      </Descriptions.Item>
      <Descriptions.Item>
        <Row gutter={16}>
          ...
          <Col span={16}>{selectedProduct.blog}</Col>
        </Row>
      </Descriptions.Item>
      ...
      <Descriptions.Item>
        <Row gutter={16}>
          ...
          <Col span={16}>{selectedProduct.material}</Col>
        </Row>
      </Descriptions.Item>
      ...
      <Descriptions.Item>
        <Row gutter={16}>
          ...
          <Col span={16}>{selectedProduct.warranty}</Col>
        </Row>
      </Descriptions.Item>
      ...
      <Descriptions.Item>
        <Row gutter={16}>
          ...
          <Col span={16}>{selectedProduct.tech_specs}</Col>
        </Row>
      </Descriptions.Item>
      ...
      <Descriptions.Item>
        <Row gutter={16}>
          ...
          <Col span={16}>{selectedProduct.stock_status}</Col>
        </Row>
      </Descriptions.Item>
      ...
      <Descriptions.Item>
        <Row gutter={16}>
          ...
          <Col span={16}>{selectedProduct.gender}</Col>
        </Row>
      </Descriptions.Item>
      ...
      <Descriptions.Item>
        <Row gutter={16}>
          ...
          <Col span={16}>{selectedProduct.isPublished ? 'Yes' : 'No'}</Col>
        </Row>
      </Descriptions.Item>
        ...
        <Row gutter={16}>
          ...
          <Col span={16}>
            {selectedProduct.publishedDate &&
              new Date(selectedProduct.publishedDate).toLocaleDateString()}
          </Col>
        </Row>
      </Descriptions.Item>

...
const CardTwo = ({
  ...
  return (
    <div
      onClick={onClick}
      className="rounded-sm cursor-pointer border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark"
    >
      <div className="flex items-center justify-between">
        ...
        {isSale && <p className="text-base">Sp bán chạy nhất</p>}
      </div>

      <div className="mt-4">
        <div>
          <h4 className="text-title-md font-bold text-black">
            {price} {isCurrency ? 'VND' : ''}
          </h4>

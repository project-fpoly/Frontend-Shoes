    ...
    return (
        <div className='shopping-cart mt-[100px] w-[70%] mx-auto'>
            <div className='grid grid-cols-3 gap-6'>
                            ...
                            <div className='cart-item-content col-span-2 px-2'>
                                <div className='flex flex-col grow'>
                                    <div className='flex flex-nowrap'>
                                        <div>
                                            <h2 className='cart-item-content font-semibold'>Product 1</h2>
                                        ...
                                        <div>
                                            <div>
                                                <p className='text-xl font-semibold'>3.000.000 <span className='font-light'>VND</span></p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="shopping-cart-summary col-span-1">
                    ...
                    <div>
                        ...
                        <div className='mt-5'>
                            <Button style={{ background: "rgb(17, 17, 17)" }} block className={style.button_checkout}>
            ...
            <div className="favourites">
                ...
                <Link to={'/'} className='underline text-lg text-gray-500'>Join us</Link> or <Link to={'/'} className='underline text-lg text-gray-500'>Sign in</Link>
            </div>
        </div>
    )
}
